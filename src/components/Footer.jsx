      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="text-lg font-semibold text-zinc-900 dark:text-white">
              Muhammad Ammar Tauqir
            </h3>
            <p className="text-zinc-600 dark:text-zinc-400">
              Software engineer and tech creator based in Germany, passionate about
              building innovative solutions and sharing knowledge.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-4">
              ...
              <a
                href="https://www.linkedin.com/in/muhammad-ammar-tauqir-5754339b/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-zinc-600 dark:text-zinc-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors"
              >
        ...
        <div className="mt-12 pt-8 border-t border-zinc-200 dark:border-zinc-800">
          <p className="text-center text-zinc-600 dark:text-zinc-400">
            © {currentYear} Muhammad Ammar Tauqir. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
